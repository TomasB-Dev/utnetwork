...
def logued_route(app,usuarios):
    ...
    def home():
        ...
        if session:
            ...
            if user_state == True:
                publicaciones = usuarios.ver_publicaciones(id_user) #traigo las publicaciones
                return render_template('home.html', usuario=info_user[0],publicaciones=publicaciones)
            else:
